...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        icon3 = QIcon()
        icon3.addFile(u"icons/arrow-turn-left-down.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.pushButton_28.setGeometry(QRect(0, 380, 481, 31))
        icon5 = QIcon()
        icon5.addFile(u"icons/plus-small.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
